...
def train_custom_images(image_path, weight_path):
    ...
    lrate = 1e-2
    save_model = False
    save_dir = './models/diffusion_outputs_custom/v5/'
    ...
    ddpm = DDPM(nn_model=ContextUnet(in_channels=1, n_feat=n_feat, weight_template_dim=128), betas=(1e-4, 0.02), n_T=n_T, device=device, drop_prob=0.1) #Added weight_template_dim, update that if it is changed
    ddpm.to(device)
...
if __name__ == "__main__":
    ...
    weight_path = "Datasets/IITD Palmprint V1/Preprocessed/Left/X_train_pca_128.npy"
