...
input_size = 128 * 128 * 1  # Example for 64x64 RGB images
...
class DiffusionSampler:
    ...
    def sample(self, condition, img_shape=(128, 128, 1)):
...
# Original image
axes[0].imshow(images[0].clone().detach().cpu().numpy().reshape(128, 128), cmap='gray')
...
# Show the plot
plt.savefig('diffusion_basic_resized.png')
plt.close()
